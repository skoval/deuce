#' ATP Elo Ratings
#'
#' This dataset contains Elo ratings for the ATP tour from the Open Era to the present including Futures, Challengers and ATP Tour events.
#'
#' \itemize{
...
#'}
#'
#' @format A data frame with 1,259,206 rows and 19 variables
#' @name atp_elo
NULL